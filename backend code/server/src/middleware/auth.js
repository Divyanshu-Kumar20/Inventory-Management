...
/**
 * Authentication Middleware: Validates JWT Access Token in HTTP Authorization Header
 */
...
/**
 * Role-Based Authorization Middleware: Restricts endpoints to Admin, Employee, or specified roles
 */
const authorizeRoles = (...roles) => {
  // Normalize roles to include 'Admin' / 'Employee' mapping
  return (req, res, next) => {
    if (!req.user) {
    ...
    // Normalize matching for Admin / Employee enterprise roles
...
module.exports = {
  authenticateUser,
  authorizeRoles,
  protect: authenticateUser,  // Alias for backward compatibility
