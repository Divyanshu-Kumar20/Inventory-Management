...
const { generateAIInsights, chatAI, analyticsAI, getInsights, getForecast, getStockoutRisk, getRestockRecommendations, seedHistory } = require('../controllers/aiController');
